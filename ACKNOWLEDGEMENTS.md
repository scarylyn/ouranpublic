...
Original project note from Kari / Scarylyn:
...
>
> I credit github user `jaga8285` as well as their special thanks to JJJewel and azerty1 for the creation of the tool.

Original extraction-tool notes:

- https://github.com/jaga8285/OuranExtractionTool/blob/main/README.md

They should be credited in the finished project. This work is built on top of that extraction effort.
